...
public class Mentors extends AppCompatActivity {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.activity_mentors, container, false);
        WebView myWebView = (WebView) v.findViewById(R.id.mentors);


        //------------------------------------- to over ride keyboard error ------------(1)
        myWebView.setWebViewClient(new WebViewClient());
        myWebView.loadUrl("https://mentor-mentee-app-mobile.herokuapp.com/mentor_dashboard");
        return v;
    }
